...
#python ./src/pharmacy_counting.py ./insight_testsuite/tests/your-own-test_1/input/itcont.txt ./insight_testsuite/tests/your-own-test_1/output/top_cost_drug.txt